 ...
 * @generated
 */
public class StudyprogSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static StudyprogPackage modelPackage;
	 ...
	 * @generated
	 */
	public StudyprogSwitch() {
		if (modelPackage == null) {
			modelPackage = StudyprogPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StudyprogPackage.MANDATORY_COURSE: {
				MandatoryCourse mandatoryCourse = (MandatoryCourse)theEObject;
				T result = caseMandatoryCourse(mandatoryCourse);
				if (result == null) result = caseCourse(mandatoryCourse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StudyprogPackage.ELECTIVE_COURSE: {
				ElectiveCourse electiveCourse = (ElectiveCourse)theEObject;
				T result = caseElectiveCourse(electiveCourse);
				if (result == null) result = caseCourse(electiveCourse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Mandatory Course</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Mandatory Course</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMandatoryCourse(MandatoryCourse object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Elective Course</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Elective Course</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseElectiveCourse(ElectiveCourse object) {
		return null;
	}
